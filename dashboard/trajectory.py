...
CONFIG_SPEC = [
    ...
    {"k": "wf_color_model", "g": "Timeline", "l": "Model colour",
     ...
     "h": "Bars for the model reasoning"},
    {"k": "wf_color_out", "g": "Timeline", "l": "Output colour", "t": "color",
     "d": "#B4642A", "cssvar": "--wf-out", "scope": "live",
     "h": "Bars for the model writing the answer"},
    ...
    {"k": "wf_labels", "g": "Timeline", "l": "Lane labels", "t": "bool",
     "d": True, "scope": "live", "h": "The Input / Model / Output / Tools gutter"},
